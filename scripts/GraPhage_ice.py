"""GraPhage_ice 
Usage:
    GraPhage_ice.py <fasta_file> <gff_dic> [--out=<fn>] [--thread=<tn>] [--batch=<bn>]
    GraPhage_ice.py (-h | --help)
    GraPhage_ice.py --version
Options:
    -o --out=<fn>   The output file name [default: GraPhage_ice_output.txt].
...
if __name__=="__main__":
    arguments = docopt(__doc__, version="GraPhage_ice 0.1.1")
    main(arguments)
