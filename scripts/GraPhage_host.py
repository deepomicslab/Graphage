"""GraPhage_host 
Usage:
    GraPhage_host.py <fasta_file> [--out=<fn>] [--thread=<tn>] [--batch=<bn>]
    GraPhage_host.py (-h | --help)
    GraPhage_host.py --version
Options:
    -o --out=<fn>   The output file name [default: GraPhage_host_output.txt].
...
if __name__=="__main__":
    arguments = docopt(__doc__, version="GraPhage_host 0.1.1")
    main(arguments)
