"""GraPhage_int 
Usage:
    GraPhage_int.py <fasta_file> <seq_type> [--out=<fn>] [--thread=<tn>] [--batch=<bn>]
    GraPhage_int.py (-h | --help)
    GraPhage_int.py --version
Options:
    -o --out=<fn>   The output file name [default: GraPhage_int_output.txt].
...
if __name__=="__main__":
    arguments = docopt(__doc__, version="GraPhage_int 0.1.1")
    main(arguments)
